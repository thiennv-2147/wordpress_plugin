...
class WDW_FM_Library {
  ...
  */
  ...
  public static function free_trial_banner_section() {
    $free_trial_plugin_link = 'https://10web.io/?utm_source=in%20plugin&utm_medium=banner&utm_campaign=form%20maker';
    wp_enqueue_style(WDFM()->prefix . '-free_trial_banner_css');
    wp_enqueue_script(WDFM()->prefix . '-free_trial_banner_js');
    ob_start();
    ?>
    <div class="tenweb_free_trial_banner tenweb-<?php echo WDFM()->prefix; ?>-free_trial_banner">
      ...
      <div class="tenweb_free_trial_banner_container">
        ...
        <div class="tenweb_free_trial_banner_info">
          ...
          <p><?php _e('Sign up for a 14-day Free Trial of Automated WordPress Platform', WDFM()->prefix); ?></p>
          <div class="tenweb_info_sec">
            <span><?php _e('Hosting on Google Cloud', WDFM()->prefix); ?></span>
            <span><?php _e('90+ PageSpeed Score', WDFM()->prefix); ?></span>
            <span><?php _e('AI Builder', WDFM()->prefix); ?></span>
            <span><?php _e('1 Click Migration', WDFM()->prefix); ?></span>
          </div>
        </div>
        <div class="tenweb_free_trial_banner_button">
          <a class="ftb-button" href="<?php echo $free_trial_plugin_link; ?>" target="_blank"><?php _e( 'learn more', WDFM()->prefix ); ?></a>
        </div>
      </div>
    </div>
    <?php
