...
function add_condition_fields( num ) {
	...
	var ids = jQuery('#fm-condition-fields-' + num).data('conditions-field-ids');
	var all_ids = jQuery('#fm-condition-fields-' + num).data('conditions-field-all-ids');
	var labels = jQuery('#fm-condition-fields-' + num).data('conditions-field-labels');
	var all_labels = jQuery('#fm-condition-fields-' + num).data('conditions-field-all-labels');
	var types = jQuery('#fm-condition-fields-' + num).data('conditions-field-types');
	var params = jQuery('#fm-condition-fields-' + num).data('conditions-field-params');
	for ( i = 500; i >= 0; i-- ) {
