...
final class WDFM {
  ...
  private function define_constants() {
    ...
    $this->plugin_version = '1.13.57';
    $this->db_version = '2.13.57';
  ...
  private function add_actions() {
    ...
    add_action('wp_ajax_fm_free_trial_banner', array($this, 'free_trial_banner_update_status'));
    add_action('wp_ajax_nopriv_fm_free_trial_banner', array($this, 'free_trial_banner_update_status'));
  ...
  public function free_trial_banner_update_status() {
    $free_trial_banner_status = add_option('wd_fm_free_trial_banner', '1', '', 'no');
